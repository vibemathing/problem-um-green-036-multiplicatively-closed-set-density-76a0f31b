...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-036-multiplicatively-closed-set-density-76a0f31b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      ...
      "obligation_graph_id": "graph:um-green-036-multiplicatively-closed-set-density-76a0f31b-v1",
      "problem_contract_sha256": "9aaef554ad3230a00f513163976d3b0eec16a138ac88a253621679acfa8d7e04",
      "problem_id": "problem:um-green-036-multiplicatively-closed-set-density-76a0f31b",
      "route_id": "route:um-green-036-multiplicatively-closed-set-density-76a0f31b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-036-multiplicatively-closed-set-density-76a0f31b-source-fidelity-01",
      "graph_id": "graph:um-green-036-multiplicatively-closed-set-density-76a0f31b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-036-multiplicatively-closed-set-density-76a0f31b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-036-multiplicatively-closed-set-density-76a0f31b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A$ be the smallest set containing 2 and 3, and closed under the operation $a_1a_2 - 1$ (if $a_1, a_2 \\in A$, then $a_1a_2 - 1 \\in A$). Does $A$ have positive density?"
          },
          "statement_sha256": "3592a1e0043fb486ab33abc4590a0b73cfbe8e6e5e9ee8fe4d766e9c6f5ebc43"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-036-multiplicatively-closed-set-density-76a0f31b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-036-multiplicatively-closed-set-density-76a0f31b-root",
      "route_id": "route:um-green-036-multiplicatively-closed-set-density-76a0f31b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-036-c0b08817874b",
        "url": "https://www.unsolvedmath.com/problems/GREEN-036"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
